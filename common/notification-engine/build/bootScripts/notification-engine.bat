...
set JARPATH=%APP_HOME%\lib\notification-engine-0.0.1-SNAPSHOT.jar

@rem Execute notification-engine
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %NOTIFICATION_ENGINE_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%NOTIFICATION_ENGINE_EXIT_CONSOLE%" exit 1
exit /b 1
