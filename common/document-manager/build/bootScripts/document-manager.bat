...
set JARPATH=%APP_HOME%\lib\document-manager-0.0.1-SNAPSHOT.jar

@rem Execute document-manager
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DOCUMENT_MANAGER_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%DOCUMENT_MANAGER_EXIT_CONSOLE%" exit 1
exit /b 1
